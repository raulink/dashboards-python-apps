...
try:
  client = pymongo.MongoClient("mongodb+srv://mcraul86:admin123@platzistore.ptgtdxs.mongodb.net/?retryWrites=true&w=majority&appName=platzistore")
